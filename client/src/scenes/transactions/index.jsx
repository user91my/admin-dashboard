        ...
        <DataGrid
          ...
          columns={
            isMinWidth1100px
              ...
              : isMinWidth650px
              ? columns.filter(
                  (column) => !excludedColumnFields1100px.includes(column.field)
                )
              : newColumns
          }
          //
          ...
          sortingMode="server"
          //
          // Structurally, the 'newSortModel' is an array containing the object model. It should look like :-
          //        [ { field: "userId", sort: "desc" } ]
          // We destructure the 'newSortModel' array in order extract the object model and ultimately send it back to the server.
